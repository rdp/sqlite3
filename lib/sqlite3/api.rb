module SQLite3
  module API
    ...
    attach_function :sqlite3_blob_open, [ :pointer, :string, :string, :string, :long_long, :int, :pointer ], :int
    ...
    attach_function :sqlite3_memory_alarm, [ callback([ :pointer, :long_long, :int ], :void), :pointer, :long_long ], :int
    attach_function :sqlite3_memory_highwater, [ :int ], :long_long
    attach_function :sqlite3_memory_used, [  ], :long_long
    ...
    attach_function :sqlite3_profile, [ :pointer, callback([ :pointer, :string, :ulong_long ], :void), :pointer ], :pointer
    ...
    attach_function :sqlite3_result_int64, [ :pointer, :long_long ], :void
    ...
    attach_function :sqlite3_update_hook, [ :pointer, callback([ :pointer, :int, :string, :string, :long_long ], :void), :pointer ], :pointer
    ...
    attach_function :sqlite3_value_int64, [ :pointer ], :long_long
